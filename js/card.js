...
(function () {
  ...
  window.card = {
    generateCard: function (card) {
      ...
      cardElement.querySelector('.popup__close').addEventListener('click', window.map.removeCard);
      document.addEventListener('keydown', window.map.closeCardButtonClickHandler);
